...
// Query untuk mengambil data gaji dan karyawan
$query_gaji = "
...
$jumlah_jam = $lembur['total_jam'] ?? 0;
$tarif_per_jam = $lembur['tarif_per_jam'] ?? 0;
$total_lembur = $lembur['total_lembur'] ?? 0;
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if(isset($rating['nilai_rating'])) {
                                        echo str_repeat('⭐', $rating['nilai_rating']) . " ({$rating['nilai_rating']})";
                                    } else {
                                        echo '-';
                                    }
                                    ?>
